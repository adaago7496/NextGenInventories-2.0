...
namespace NextGenInventories_2._0.Controllers
{
    public class ProductTypesController : Controller
    {
        ...
        public ProductTypesController(NextGenInventories_2_0Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ProductType != null ? 
                          ...
                          Problem("Entity set 'NextGenInventories_2_0Context.ProductType'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NextGenInventories_2_0Context.ProductType'  is null.");
            }
            var productType = await _context.ProductType.FindAsync(id);
            if (productType != null)
            {
